...
namespace Meeting_8
{
    ...
    {//------------------------------------------------------------------------
        ...
        public CardDeck() { _cardDeck = new Queue<Card>(36); }
        //---------------------------------------------------------------------
        public void Mix()
        {
            Card[] mixedCards = _cardDeck.ToArray().Mix();
            _cardDeck.Clear();
        ...
        //---------------------------------------------------------------------
        public void Add(Card card) { _cardDeck.Enqueue(card); }
        public Card Take() { return _cardDeck?.Dequeue(); }
    }//------------------------------------------------------------------------
}
